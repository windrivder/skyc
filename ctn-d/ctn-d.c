...
struct cgrp_control *cgrps[] = {
    ...
    /* 		& (struct cgrp_setting) { */
    /* 			.name = "blkio.weight", // not found in
       kernel 5.10+, 6.1+ */
    /* 			.value = "10" */
    /* 		}, */
    /* 		&add_to_tasks, */
...
int child(void *arg) {
  ...
  if (sethostname(config->hostname, strlen(config->hostname)) ||
      setup_mounts(config) || setup_userns(config) || setup_capabilities() ||
      setup_seccomp()) {
    close(config->fd);
    return -1;
  }
...
int main(int argc, char **argv) {
  ...
  //////////////////////////////////////////////////////////////////////////
  // Step 1: parse CLI parameters, validate Linux kernel/cpu/..., generate
...
finish_options:
  ...
  //////////////////////////////////////////////////////////////////////////
  // Step 2: setup a socket pair for container sending messages to the parent
  // process
  //////////////////////////////////////////////////////////////////////////
